...
function Reviews() {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center gap-8 md:ml-[7rem] md:mr-[7rem]">
      ...
      <section className="flex flex-col justify-center items-center bg-white p-6 rounded-lg shadow-md w-full sm:w-[300px] md:w-[400px] lg:w-[500px] xl:w-1/3 2xl:w-[700px] ml-[2rem] mr-[2rem]">
