...
function About() {
  ...
  return (
    <div className="w-full h-full pl-[15rem] pr-[15rem]">
      <section className="flex-1 flex flex-col justify-around items-center pl-10 pr-10">
        ...
        <div className="flex justify-around items-center">
          <img
            ...
            alt="Equipe GreenRoots"
            className="w-[300px] object-cover"
            loading="lazy"
          />
        </div>

        <ul className="text-gray-700 mt-6 mb-4 flex flex-col justify-around items-center">
      ...
      <section className="flex flex-col justify-around items-center pl-10 pr-10">
      ...
      <section className="flex flex-col justify-around items-center pl-10 pr-10">
        ...
        <p>
          ...
          inclut une procédure de déploiement et utilise Git et GitHub pour le
          suivi des versions. Accessibilité : Le site respecte les normes
          d’accessibilité WCAG. RGPD : Les mentions légales et la politique de
          confidentialité sont conformes à la réglementation RGPD. SEO : Des
          optimisations SEO ont été appliquées pour le référencement.
        </p>
        ...
        <p>
          ...
          utilisateurs et suivre les arbres. Intégration d'un système de
          paiement sécurisé pour permettre de véritables transactions.
        </p>
